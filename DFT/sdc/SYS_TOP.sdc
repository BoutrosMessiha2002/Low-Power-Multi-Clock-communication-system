...
# Created by write_sdc on Mon Oct 21 17:28:20 2024
...
create_clock [get_ports scan_clk]  -name DFT_CLK  -period 200  -waveform {0 100}
...
set_clock_transition -min -fall 0.1 [get_clocks DFT_CLK]
set_clock_transition -max -fall 0.1 [get_clocks DFT_CLK]
set_clock_transition -min -rise 0.1 [get_clocks DFT_CLK]
set_clock_transition -max -rise 0.1 [get_clocks DFT_CLK]
set_input_delay -clock UART_RX_CLK  54.2534  [get_ports UART_RX_IN]
set_input_delay -clock DFT_CLK  40  [get_ports test_mode]
set_input_delay -clock DFT_CLK  40  [get_ports SI]
set_input_delay -clock DFT_CLK  40  [get_ports SE]
...
set_output_delay -clock DFT_CLK  40  [get_ports SO]
...
set_clock_groups -asynchronous -name REF_CLK_2 -group [get_clocks REF_CLK] -group [get_clocks DFT_CLK]
set_clock_groups -asynchronous -name ALU_CLK_1 -group [get_clocks ALU_CLK] -group [get_clocks DFT_CLK]
set_clock_groups -asynchronous -name UART_CLK_1 -group [get_clocks UART_CLK] -group [get_clocks DFT_CLK]
set_clock_groups -asynchronous -name UART_TX_CLK_1 -group [get_clocks UART_TX_CLK] -group [get_clocks DFT_CLK]
set_clock_groups -asynchronous -name UART_RX_CLK_1 -group [get_clocks UART_RX_CLK] -group [get_clocks DFT_CLK]
